...
<header style="opacity:1;" class="header">
        ...
        <div class="header-logo-global">
            <h1 class="animated-title" style="margin:0;">
                <span class="logo_cadre logo-glow" style="display:inline-flex;align-items:center;justify-content:center;">
                    <a href="<?php echo $domaine; ?>" class="logo-link-global">
        ...
        <nav class="header-nav">
            <div class="nav-desktop custom-nav-desktop">
                ...
                <ul class="liens_content custom-liens-content">
                    <li><a href="<?php echo $domaine; ?>">Home</a></li>
                    <li><a href="<?php echo $domaine; ?>vote/">Voter</a></li>
                    <li><a href="<?php echo $domaine; ?>contact/">Contact us</a></li>
                    <li><a href="<?php echo $domaine; ?>results/">Résultats</a></li>
                    <li><a href="<?php echo $domaine; ?>galerie/">Galerie</a></li>
                </ul>
            ...
            <details class="nav-mobile custom-nav-mobile">
                <summary class="custom-nav-summary"><img src="<?php echo $domaine; ?>templates/pictures/icons8-menu.svg" alt="⇶" class="custom-menu-icon"></summary>
    ...
    color: #222;
                ...
                @media (max-width: 900px) {
                    .header-logo-global { margin-bottom: 0.5rem; display: flex !important; }
